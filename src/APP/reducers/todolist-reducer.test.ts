...
test('todolist should be add', () => {
    const endState = TodolistReducer(initialState, addTodolistAC(v1(), 'newTodolist'))
...
test('filter todolist should be changed', () => {
    const endState = TodolistReducer(initialState, changeFilterTodolist(todolistId1, 'Completed'))
